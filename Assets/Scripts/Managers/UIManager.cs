...
public class UIManager : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        //GameSceneCanvas.sortingOrder = 1; // should be 1, given that inGameCanvas should be part of the game Itself. 
    ...
    public T ShowPopUpUI<T>(T popUpUI) where T: PopUpUI
    {
        ...
        T ui = GameManager.Pool.GetUI<T>(popUpUI); // 없다면 새로 생성, 아니라면 그냥 꺼내올것 
